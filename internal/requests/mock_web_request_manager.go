...
func (mock *MockWebRequestManager) GetWsTrustResponse(authParameters msalbase.AuthParametersInternal, cloudAudienceURN string, endpoint wstrust.Endpoint) (*wstrust.Response, error) {
	args := mock.Called(authParameters, cloudAudienceURN, endpoint)
	return args.Get(0).(*wstrust.Response), args.Error(1)
}

func (mock *MockWebRequestManager) GetAccessTokenFromSamlGrant(authParameters msalbase.AuthParametersInternal, samlGrant wstrust.SamlTokenInfo) (msalbase.TokenResponse, error) {
...
func (mock *MockWebRequestManager) GetAccessTokenFromAuthCode(authParameters msalbase.AuthParametersInternal, authCode, codeVerifier string, params map[string]string) (msalbase.TokenResponse, error) {
	args := mock.Called(authParameters, authCode, codeVerifier, params)
	return args.Get(0).(msalbase.TokenResponse), args.Error(1)
}

func (mock *MockWebRequestManager) GetAccessTokenFromRefreshToken(authParameters msalbase.AuthParametersInternal, refreshToken string, params map[string]string) (msalbase.TokenResponse, error) {
	args := mock.Called(authParameters, refreshToken, params)
	return args.Get(0).(msalbase.TokenResponse), args.Error(1)
}

func (mock *MockWebRequestManager) GetAccessTokenWithClientSecret(authParameters msalbase.AuthParametersInternal, clientSecret string) (msalbase.TokenResponse, error) {
	args := mock.Called(authParameters, clientSecret)
	return args.Get(0).(msalbase.TokenResponse), args.Error(1)
}

func (mock *MockWebRequestManager) GetAccessTokenWithAssertion(authParameters msalbase.AuthParametersInternal, assertion string) (msalbase.TokenResponse, error) {
...
func (mock *MockWebRequestManager) GetAccessTokenFromDeviceCodeResult(authParameters msalbase.AuthParametersInternal, deviceCodeResult msalbase.DeviceCodeResult) (msalbase.TokenResponse, error) {
