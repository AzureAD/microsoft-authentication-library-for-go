...
This is a known limitation compared to msal-dotnet. A future improvement could add a configurable DLL path via an option or environment variable, or detect absence and return a clear error before attempting the call.
