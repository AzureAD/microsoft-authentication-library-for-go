...
func (n noopCacheAccessor) Replace(ctx context.Context, cache cache.Unmarshaler, key string) {}
func (n noopCacheAccessor) Export(ctx context.Context, cache cache.Marshaler, key string)    {}
